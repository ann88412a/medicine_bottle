...
img = cv2.imread('/home/medical/medicine_bottle/pictures/test.png')#nano location:'/home/medical/medicine_bottle/pictures/test.png'
# print(np.array(img))
# cv2.imshow("1", img)
...
cv2.waitKey(0)
cv2.imwrite('./pictures/square_detect.png',img)
