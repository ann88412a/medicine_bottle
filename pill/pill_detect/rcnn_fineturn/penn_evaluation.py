...
data_dir = os.path.abspath(os.getcwd()) + '/pill/pill_detect/rcnn_fineturn/PennFudanPed/PNGImages/'
mask_dir = os.path.abspath(os.getcwd()) + '/pill/pill_detect/rcnn_fineturn/PennFudanPed/PedMasks/'
...
def main():
    ...
    path = os.path.abspath(os.getcwd()) + '/model.pth'
